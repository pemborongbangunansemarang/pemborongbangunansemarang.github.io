<?php
namespace madxartworkPro\Modules\DynamicTags\ACF;

use madxartwork\Modules\DynamicTags;
		...
		foreach ( $acf_groups as $acf_group ) {
			...
			foreach ( $fields as $field ) {
				...
				if ( $has_option_page_location ) {
					...
					$options[ $key ] = __( 'Options', 'madxartwork-pro' ) . ':' . $field['label'];
