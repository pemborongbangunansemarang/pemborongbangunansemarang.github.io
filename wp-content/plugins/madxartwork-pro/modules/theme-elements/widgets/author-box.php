...
class Author_Box extends Base {
	...
	public function get_title() {
		return __( 'Author Box', 'madxartwork-pro' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_author_info',
			[
				'label' => __( 'Author Info', 'madxartwork-pro' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'current',
				'options' => [
					'current' => __( 'Current Author', 'madxartwork-pro' ),
		...
		$this->add_control(
			'show_avatar',
			[
				'label' => __( 'Profile Picture', 'madxartwork-pro' ),
				'type' => Controls_Manager::SWITCHER,
				'prefix_class' => 'madxartwork-author-box--avatar-',
		...
		$this->add_control(
			'show_name',
			[
				'label' => __( 'Display Name', 'madxartwork-pro' ),
				'type' => Controls_Manager::SWITCHER,
				'prefix_class' => 'madxartwork-author-box--name-',
				'label_on' => __( 'Show', 'madxartwork-pro' ),
				'label_off' => __( 'Hide', 'madxartwork-pro' ),
				'default' => 'yes',
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'website' => __( 'Website', 'madxartwork-pro' ),
					'posts_archive' => __( 'Posts Archive', 'madxartwork-pro' ),
				],
				'condition' => [
					'source!' => 'custom',
				],
				'description' => __( 'Link for the Author Name and Image', 'madxartwork-pro' ),
			]
		);
		...
		$this->add_control(
			'show_biography',
			[
				'label' => __( 'Biography', 'madxartwork-pro' ),
				'type' => Controls_Manager::SWITCHER,
				'prefix_class' => 'madxartwork-author-box--biography-',
				'label_on' => __( 'Show', 'madxartwork-pro' ),
				'label_off' => __( 'Hide', 'madxartwork-pro' ),
				'default' => 'yes',
				'condition' => [
		...
		$this->add_control(
			'show_link',
			[
				'label' => __( 'Archive Button', 'madxartwork-pro' ),
				'type' => Controls_Manager::SWITCHER,
				'prefix_class' => 'madxartwork-author-box--link-',
				'label_on' => __( 'Show', 'madxartwork-pro' ),
				'label_off' => __( 'Hide', 'madxartwork-pro' ),
				'default' => 'no',
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'madxartwork-pro' ),
				'rows' => 3,
				'condition' => [
					'source' => 'custom',
				],
		...
		$this->add_control(
			'link_text',
			[
				'label' => __( 'Archive Text', 'madxartwork-pro' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'All Posts', 'madxartwork-pro' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => 'before',
				'prefix_class' => 'madxartwork-author-box--layout-image-',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'prefix_class' => 'madxartwork-author-box--align-',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'prefix_class' => 'madxartwork-author-box--image-valign-',
				'condition' => [
					'layout!' => 'above',
				],
			]
		...
		$this->add_responsive_control(
			'image_size',
			[
				'label' => __( 'Image Size', 'madxartwork-pro' ),
				...
				'selectors' => [
					'{{WRAPPER}} .madxartwork-author-box__avatar img' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'body.rtl {{WRAPPER}}.madxartwork-author-box--layout-image-left .madxartwork-author-box__avatar, 
					 body:not(.rtl) {{WRAPPER}}:not(.madxartwork-author-box--layout-image-above) .madxartwork-author-box__avatar' => 'margin-right: {{SIZE}}{{UNIT}}; margin-left: 0;',

					'body:not(.rtl) {{WRAPPER}}.madxartwork-author-box--layout-image-right .madxartwork-author-box__avatar, 
					 body.rtl {{WRAPPER}}:not(.madxartwork-author-box--layout-image-above) .madxartwork-author-box__avatar' => 'margin-left: {{SIZE}}{{UNIT}}; margin-right:0;',

					'{{WRAPPER}}.madxartwork-author-box--layout-image-above .madxartwork-author-box__avatar' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SWITCHER,
				'selectors' => [
					'{{WRAPPER}} .madxartwork-author-box__avatar img' => 'border-style: solid',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#000',
				'selectors' => [
					'{{WRAPPER}} .madxartwork-author-box__avatar img' => 'border-color: {{VALUE}}',
				],
				'condition' => [
					'image_border' => 'yes',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .madxartwork-author-box__avatar img' => 'border-width: {{SIZE}}{{UNIT}}',
				],
				'condition' => [
					'image_border' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} .madxartwork-author-box__avatar img' => 'border-radius: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .madxartwork-author-box__avatar img',
				'fields_options' => [
					'box_shadow_type' => [
						'separator' => 'default',
					],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .madxartwork-author-box__name' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .madxartwork-author-box__name',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .madxartwork-author-box__name' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .madxartwork-author-box__bio' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'bio_typography',
				'selector' => '{{WRAPPER}} .madxartwork-author-box__bio',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .madxartwork-author-box__bio' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .madxartwork-author-box__button' => 'color: {{VALUE}}; border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .madxartwork-author-box__button' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .madxartwork-author-box__button',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .madxartwork-author-box__button:hover' => 'border-color: {{VALUE}}; color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .madxartwork-author-box__button:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .madxartwork-author-box__button' => 'border-width: {{SIZE}}{{UNIT}};',
				],
				'separator' => 'before',
				'condition' => [
					'link_text!' => '',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .madxartwork-author-box__button' => 'border-radius: {{SIZE}}{{UNIT}};',
				],
				'separator' => 'after',
				'condition' => [
					'link_text!' => '',
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .madxartwork-author-box__button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'button',
			'class', [
				'madxartwork-author-box__button',
				'madxartwork-button',
				'madxartwork-size-xs',
			]
		);
		...
		if ( $print_link && ! empty( $settings['button_hover_animation'] ) ) {
			$this->add_render_attribute(
				'button',
				'class',
				'madxartwork-animation-' . $settings['button_hover_animation']
			);
		}
		...
		?>
		<div class="madxartwork-author-box">
			<?php if ( $print_avatar ) { ?>
				<<?php echo $link_tag; ?> <?php echo $this->get_render_attribute_string( 'author_link' ); ?> class="madxartwork-author-box__avatar">
					<img <?php echo $this->get_render_attribute_string( 'avatar' ); ?>>
				</<?php echo $link_tag; ?>>
			<?php } ?>

			<div class="madxartwork-author-box__text">
				<?php if ( $print_name ) : ?>
					<<?php echo $link_tag; ?> <?php echo $this->get_render_attribute_string( 'author_link' ); ?>>
						<?php echo '<' . $author_name_tag . ' class="madxartwork-author-box__name">' . $author['display_name'] . '</' . $author_name_tag . '>'; ?>
					</<?php echo $link_tag; ?>>
				<?php endif; ?>

				<?php if ( $print_bio ) : ?>
					<div class="madxartwork-author-box__bio">
						<?php echo $author['bio']; ?>
					</div>
				<?php endif; ?>
