...
class Mailpoet3 extends Action_Base {
	...
	public function register_settings_section( $widget ) {
		$widget->start_controls_section(
			'section_mailpoet3',
			[
				'label' => __( 'MailPoet 3', 'madxartwork-pro' ),
				'condition' => [
		...
		$mailpoet_fields = [
			[
				...
				'remote_label' => __( 'First Name', 'madxartwork-pro' ),
				'remote_type' => 'text',
			],
			[
				'remote_id' => 'last_name',
				'remote_label' => __( 'Last Name', 'madxartwork-pro' ),
				'remote_type' => 'text',
			],
			[
				'remote_id' => 'email',
				'remote_label' => __( 'Email', 'madxartwork-pro' ),
				'remote_type' => 'email',
