<?php
namespace madxartworkPro\Modules\QueryControl\Classes;
...
class madxartwork_Post_Query {
	...
	/**
	 * madxartwork_Post_Query constructor.
	 *
	...
	public function get_query() {
		...
		do_action( 'madxartwork/query/query_results', $query, $this->widget );
	...
	public function get_query_args() {
		...
		if ( 'current_query' === $post_type ) {
			 ...
			 */
			$current_query_vars = apply_filters_deprecated( 'madxartwork_pro/query_control/get_query_args/current_query', [ $current_query_vars ], '2.5.0', 'madxartwork/query/get_query_args/current_query' );
			$current_query_vars = apply_filters( 'madxartwork/query/get_query_args/current_query', $current_query_vars );
		...
		$this->query_args = apply_filters( 'madxartwork/query/query_args', $this->query_args, $this->widget );
	...
	public function pre_get_posts_query_filter( $wp_query ) {
		if ( $this->widget ) {
			...
			/**
			 * madxartwork Pro posts widget Query args.
			 *
			 ...
			 */
			do_action_deprecated( "madxartwork_pro/{$widget_name}/query/{$query_id}", [ $wp_query, $this->widget ], '2.5.0', "madxartwork/query/{$query_id}" );
			do_action( "madxartwork/query/{$query_id}", $wp_query, $this->widget );
		}
	}
