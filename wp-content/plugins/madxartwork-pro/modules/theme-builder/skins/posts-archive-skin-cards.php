...
use madxartworkPro\Modules\Posts\Skins\Skin_Cards;
...
class Posts_Archive_Skin_Cards extends Skin_Cards {
	...
	protected function _register_controls_actions() {
		...
		add_action( 'madxartwork/element/archive-posts/archive_cards_section_design_image/before_section_end', [ $this, 'register_additional_design_image_controls' ] );
	}
	...
	public function get_container_class() {
		...
		return 'madxartwork-posts--skin-cards';
	}
