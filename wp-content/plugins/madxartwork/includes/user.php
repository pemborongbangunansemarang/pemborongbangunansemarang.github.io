 ...
 * madxartwork user.
 *
 * madxartwork user handler class is responsible for checking if the user can edit
 * with madxartwork and displaying different admin notices.
 *
 * @since 1.0.0
 */
class User {
	 ...
	 */
	const ADMIN_NOTICES_KEY = 'madxartwork_admin_notices';

	const INTRODUCTION_KEY = 'madxartwork_introduction';

	const BETA_TESTER_META_KEY = 'madxartwork_beta_tester';
	 ...
	 * @var string API URL.
	 */
	const BETA_TESTER_API_URL = 'https://my.madxartwork.com/api/v1/beta_tester/';

	/**
	 * Init.
	 *
	 * Initialize madxartwork user.
	 *
	 * @since 1.0.0
	 * @access public
	 * @static
	...
	public static function init() {
		add_action( 'wp_ajax_madxartwork_set_admin_notice_viewed', [ __CLASS__, 'ajax_set_admin_notice_viewed' ] );
		add_action( 'admin_post_madxartwork_set_admin_notice_viewed', [ __CLASS__, 'ajax_set_admin_notice_viewed' ] );

		add_action( 'madxartwork/ajax/register_actions', [ __CLASS__, 'register_ajax_actions' ] );
	}
	...
	/**
	 * Is current user can access madxartwork.
	 *
	 * Whether the current user role is not excluded by madxartwork Settings.
	 *
	 * @since 2.1.7
	 * @access public
	 * @static
	...
	public static function is_current_user_in_editing_black_list() {
		...
		$exclude_roles = get_option( 'madxartwork_exclude_user_roles', [] );
	 ...
	 *
	 * Fired by `wp_ajax_madxartwork_set_admin_notice_viewed` action.
	 *
	 * @since 1.0.0
	 * @access public
	 * @static
