...
/**
 * madxartwork elements manager.
 *
 * madxartwork elements manager handler class is responsible for registering and
...
class Elements_Manager {
	 ...
	 *
	 * Initializing madxartwork elements manager.
	 *
	 * @since 1.0.0
	 * @access public
	 */
	 ...
	 * Init elements.
	 *
	 * Initialize madxartwork elements by registering the supported elements.
	 * madxartwork supports by default `section` element and `column` element.
	 *
	 * @since 2.0.0
	 * @access private
	 */
	private function init_elements() {
		 ...
		 *
		 * Fires after madxartwork elements are registered.
		 *
		 * @since 1.0.0
		 */
		do_action( 'madxartwork/elements/elements_registered' );
	}
	...
	private function init_categories() {
		$this->categories = [
			'basic' => [
				'title' => __( 'Basic', 'madxartwork' ),
				'icon' => 'eicon-font',
			],
			'pro-elements' => [
				'title' => __( 'Pro', 'madxartwork' ),
			],
			'general' => [
				'title' => __( 'General', 'madxartwork' ),
				'icon' => 'eicon-font',
			],
			'theme-elements' => [
				'title' => __( 'Site', 'madxartwork' ),
				'active' => false,
			],
			'woocommerce-elements' => [
				'title' => __( 'WooCommerce', 'madxartwork' ),
				'active' => false,
			],
		];
		 ...
		 */
		do_action( 'madxartwork/elements/categories_registered', $this );

		$this->categories['pojo'] = [
			'title' => __( 'Pojo Themes', 'madxartwork' ),
			'icon' => 'eicon-pojome',
		];

		$this->categories['wordpress'] = [
			'title' => __( 'WordPress', 'madxartwork' ),
	 ...
	 * Require files.
	 *
	 * Require madxartwork element base class and column, section and repeater
	 * elements.
	 *
	 * @since 1.0.0
	 * @access private
	...
	private function require_files() {
		require_once madxartwork_PATH . 'includes/base/element-base.php';

		require madxartwork_PATH . 'includes/elements/column.php';
		require madxartwork_PATH . 'includes/elements/section.php';
		require madxartwork_PATH . 'includes/elements/repeater.php';
	}
}
