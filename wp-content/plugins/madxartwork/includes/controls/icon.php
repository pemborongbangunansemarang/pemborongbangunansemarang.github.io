	...
	public function content_template() {
		...
		<div class="madxartwork-control-field">
			...
			<div class="madxartwork-control-input-wrapper">
				<select id="<?php echo $control_uid; ?>" class="madxartwork-control-icon" data-setting="{{ data.name }}" data-placeholder="<?php echo __( 'Select Icon', 'madxartwork' ); ?>">
					<option value=""><?php echo __( 'Select Icon', 'madxartwork' ); ?></option>
