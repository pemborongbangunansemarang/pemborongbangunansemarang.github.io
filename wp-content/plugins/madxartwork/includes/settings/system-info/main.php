<?php
namespace madxartwork\System_Info;

use madxartwork\System_Info\Classes\Abstracts\Base_Reporter;
use madxartwork\System_Info\Helpers\Model_Helper;
...
/**
 * madxartwork main system info page.
 *
 * madxartwork main system info page handler class responsible for creating system info
 * reports and displaying them on WordPress dashboard under madxartwork setting.
 *
 * @since 1.0.0
 */
class Main {
	 ...
	 *
	 * Holds the user capabilities required to manage madxartwork menus.
	 *
	 * @since 1.0.0
	 * @access private
	 *
	 ...
	 *
	 * Holds the settings required for madxartwork system info page.
	 *
	 * @since 1.0.0
	 * @access private
	 *
	...
	/**
	 * madxartwork system info reports.
	 *
	 * Holds an array of available reports in madxartwork system info page.
	 *
	 * @since 1.0.0
	 * @access private
	 *
	 ...
	 *
	 * Initializing madxartwork system info page.
	 *
	 * @since 1.0.0
	 * @access public
	 */
	 ...
	 * Require files.
	 *
	 * Require the needed files for madxartwork system info page.
	 *
	 * @since 1.0.0
	 * @access private
	 */
	 ...
	 * Create a report.
	 *
	 * Register a new report that will be displayed in madxartwork system info page.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	private function add_actions() {
		...
		add_action( 'wp_ajax_madxartwork_system_info_download_file', [ $this, 'download_file' ] );
	}
	...
	public function display_page() {
		...
		?>
		<div id="madxartwork-system-info">
			<h3><?php echo __( 'System Info', 'madxartwork' ); ?></h3>
			<div><?php $this->print_report( $reports, 'html' ); ?></div>
			<h3><?php echo __( 'Copy & Paste Info', 'madxartwork' ); ?></h3>
			<div id="madxartwork-system-info-raw">
				<label id="madxartwork-system-info-raw-code-label" for="madxartwork-system-info-raw-code"><?php echo __( 'You can copy the below info as simple text with Ctrl+C / Ctrl+V:', 'madxartwork' ); ?></label>
				<textarea id="madxartwork-system-info-raw-code" readonly>
					<?php
				...
				<script>
					var textarea = document.getElementById( 'madxartwork-system-info-raw-code' );
			...
			<form action="<?php echo admin_url( 'admin-ajax.php' ); ?>" method="post">
				<input type="hidden" name="action" value="madxartwork_system_info_download_file">
				<input type="submit" class="button button-primary" value="<?php echo __( 'Download System Info', 'madxartwork' ); ?>">
			</form>
		</div>
		<?php
	}
	 ...
	 *
	 * Fired by `wp_ajax_madxartwork_system_info_download_file` action.
	 *
	 * @since 1.0.0
	 * @access public
	 */
	public function download_file() {
		if ( ! current_user_can( $this->capability ) ) {
			wp_die( __( 'You don\'t have permissions to download this file', 'madxartwork' ) );
		}
	 ...
	 * Register admin menu.
	 *
	 * Add new madxartwork system info admin menu.
	 *
	...
	public function register_menu() {
		$system_info_text = __( 'System Info', 'madxartwork' );
	...
	protected function get_default_settings() {
		...
		$base_lib_dir = madxartwork_PATH . 'includes/settings/system-info/';
	 ...
	 * Init settings.
	 *
	 * Initialize madxartwork system info page by setting default settings.
	 *
	 * @since 1.0.0
	 * @access private
	 */
	 ...
	 * @access public
	 *
	 * @param array $setting   Optional. Settings required for madxartwork system
	 ...
	 * Get allowed reports.
	 *
	 * Retrieve the available reports in madxartwork system info page.
	 *
	 * @since 1.0.0
	 * @access public
	 * @static
	 *
	 * @return array Available reports in madxartwork system info page.
	 */
	 ...
	 * Add report.
	 *
	 * Register a new report to madxartwork system info page.
	 *
	 * @since 1.4.0
	 * @access public
	 * @static
