 ...
 * Plugin URI: https://madxartwork.com/?utm_source=safe-mode&utm_campaign=plugin-uri&utm_medium=wp-dash
 * Author: madxartwork.com
 * Version: 1.0.0
 * Author URI: https://madxartwork.com/?utm_source=safe-mode&utm_campaign=author-uri&utm_medium=wp-dash
 *
...
class Safe_Mode {
	...
	public function plugin_row_meta( $plugin_meta, $plugin_file, $plugin_data, $status ) {
		if ( basename( __FILE__ ) === $plugin_file ) {
			$row_meta = [
				'docs' => '<a href="https://go.madxartwork.com/safe-mode/" aria-label="' . esc_attr( __( 'Learn More', 'madxartwork' ) ) . '" target="_blank">' . __( 'Learn More', 'madxartwork' ) . '</a>',
			];
