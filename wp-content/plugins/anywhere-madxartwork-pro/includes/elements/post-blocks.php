...
use madxartworkPro\Modules\woocommerce\Widgets\Elements;
use WP_Query;
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => __('Know more about Block Layouts <a href="http://aedocs.MadxArtwork.net/article/9-creating-block-layout-in-anywhere-madxartwork-pro" target="_blank">Click Here</a>','ae-pro')
            ]
        );
        if(class_exists('acf') &&  is_plugin_active('pods/init.php')) {
            $this->add_control(
        ...
        $this->add_control(
           'query_filter',
            [
                ...
                'description'   => __('<span style="color:red">Danger Ahead!!</span> It is a developer oriented feature. Only use if you know how exaclty WordPress queries and filters works.  <a href="https://aedocs.MadxArtwork.net/article/32-add-your-own-filters-to-post-blocks-query" target="_blank">Read Instructions</a>', 'ae-pro')
            ]
        );
	                            ...
	                            while($post_items->have_posts()){
                                    ...
                                    <article <?php echo $this->get_render_attribute_string('post-list-item'); ?>>
                                        <div <?php echo $this->get_render_attribute_string('article-inner'); ?>>
                                            <div class="ae_data madxartwork madxartwork-<?php echo $template; ?>">
					                            <?php
...
\madxartwork\Plugin::instance()->widgets_manager->register_widget_type( new Aepro_Post_Blocks() );