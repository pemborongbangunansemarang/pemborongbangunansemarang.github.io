	...
	protected function _register_controls() {
		...
		$this->add_group_control(
				...
				[
						...
						'selector' => '{{WRAPPER}} .madxartwork-widget-container > div:not(.cf-type-image) > .ae-element-custom-field, {{WRAPPER}} .cf-type-image img',
						'condition' => [
								'cf_type!' => 'video',
						]
				]
			...
			case "video":  add_filter( 'oembed_result', [ $this, 'ae_filter_oembed_result' ], 50, 3 );
						   ...
						   $custom_field_html .= "<script type='text/javascript'>
												     jQuery(document).ready(function(){
												     	jQuery(document).trigger('madxartwork/render/cf-video',['".$eid."','".$settings['aspect_ratio']."']);
												     });
...
\madxartwork\Plugin::instance()->widgets_manager->register_widget_type( new Aepro_Custom_Field() );