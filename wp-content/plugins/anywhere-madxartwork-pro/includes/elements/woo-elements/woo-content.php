...
class Aepro_Woo_Content extends Widget_Base{
    ...
    protected function render( ) {
        ...
        <?php else:
            ...
            $edit_mode = get_post_meta($product->get_id(),'_madxartwork_edit_mode','');
            if(isset($edit_mode[0]) && $edit_mode[0] == 'builder'){
                $product_description = '<div class="ae_data madxartwork madxartwork-<?php echo $product_id; ?>">';
                $product_description .=  madxartwork\Plugin::instance()->frontend->get_builder_content( $product->get_id() );
...
\madxartwork\Plugin::instance()->widgets_manager->register_widget_type( new Aepro_Woo_Content() );