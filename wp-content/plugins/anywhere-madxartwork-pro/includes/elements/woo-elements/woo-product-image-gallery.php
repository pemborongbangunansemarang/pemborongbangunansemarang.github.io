        ...
        switch($gallery_type){
            case 'swipe':   if($settings['open_lightbox'] != 'no') {
                                $this->add_render_attribute('link', [
                                    ...
                                    'data-madxartwork-lightbox-slideshow' => $product->get_id(),
                                ]);
                            }
                            $loop = $settings['loop'];
...
\madxartwork\Plugin::instance()->widgets_manager->register_widget_type( new Aepro_Woo_Product_Image_Gallery() );
