				                   ...
				                   if ( $settings['show_excerpt'] ) { ?>
                                    ...
                                    <?php } else { ?>
                                            ...
                                            if ( $settings['enable_the_content_hooks'] == 'yes' ) {
                                                ...
                                                if ( Plugin::$instance->db->is_built_with_madxartwork( $post_data->ID ) ) {
                                                    echo madxartwork\Plugin::instance()->frontend->get_builder_content( $post_data->ID, true );
                                                } else {
...
\madxartwork\Plugin::instance()->widgets_manager->register_widget_type( new Aepro_Post_Content() );