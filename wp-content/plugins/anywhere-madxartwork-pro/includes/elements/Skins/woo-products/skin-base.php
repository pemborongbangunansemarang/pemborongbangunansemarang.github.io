...
use madxartwork\Skin_Base as Ae_Skin_Base;
...
abstract class Skin_Base extends Ae_Skin_Base {
    ...
    {
        add_action('madxartwork/element/ae-woo-products/section_layout/before_section_end', [$this, 'register_controls']);

        add_action('madxartwork/element/ae-woo-products/section_style/before_section_end', [$this, 'register_style_controls']);
    }
    ...
    protected function product_query_controls(){
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => __('Know more about templates <a href="http://aedocs.MadxArtwork.net/article/9-creating-block-layout-in-anywhere-madxartwork-pro" target="_blank">Click Here</a>','ae-pro')
            ]
        );
