...
abstract class Skin_Base extends madxartwork_Skin_Base
{
    ...
    {
        add_action('madxartwork/element/ae-acf-gallery/section_layout/before_section_end', [$this, 'register_controls']);

        add_action('madxartwork/element/ae-acf-gallery/section_style/before_section_end', [$this, 'register_style_controls']);

        add_action('madxartwork/element/ae-acf-gallery/section_overlay/before_section_end', [$this, 'register_overlay_controls']);

        add_action('madxartwork/element/ae-acf-gallery/section_overlay_style/before_section_end', [$this, 'register_overlay_style_controls']);
    ...
    protected function get_gallery_data(){
        ...
        if($post_data->post_type == 'madxartwork_library'){
            return false;
        }
           ...
           // $this->parent->add_render_attribute('outer-wrapper', 'data-direction', $direction);
            ...
            if($this->get_instance_value('open_lightbox') != 'no') {
                $this->parent->add_render_attribute('link', [
                    'data-madxartwork-open-lightbox' => $this->get_instance_value('open_lightbox'),
                    'data-madxartwork-lightbox-slideshow' => $this->parent->get_id(),
                ]);
