...
function wts_ae_butterbean( $butterbean, $post_type ) {
    ...
    $butterbean->register_manager(
        'ae_pro',
        array(
            'label'     => esc_html__( 'AnyWhere madxartwork Settings', 'ae-pro' ),
    ...
    $manager->register_control(
        ...
        array(
            ...
            'description' => esc_html__('Use madxartwork Canvas Template','ae-pro'),
            'attr'    => array( 'class' => 'ae_rules_control ae_post ae_archive' ),
        )
    );
    ...
    **/
    ...
    $manager->register_control(
        ...
        [
            ...
            'choices'   => [
                    ''      => 'Theme Default',
                    'ec'    => 'madxartwork Canvas',
                    'ehf'   => 'madxartwork Full Width'
...
function add_ae_meta_box(){
    add_meta_box('ae-shortcode-box','Anywhere madxartwork Usage','Aepro\ae_pro_shortcode_box','ae_global_templates','side','high');
}
...
function ae_pro_shortcode_box($post){
    ...
    <input type='text' class='widefat' value='[INSERT_madxartwork id="<?php echo $post->ID; ?>"]' readonly="">

    <h4 style="margin-bottom:5px;">Php Code</h4>
    <input type='text' class='widefat' value="&lt;?php echo do_shortcode('[INSERT_madxartwork id=&quot;<?php echo $post->ID; ?>&quot;]'); ?&gt;" readonly="">
    <?php
}
