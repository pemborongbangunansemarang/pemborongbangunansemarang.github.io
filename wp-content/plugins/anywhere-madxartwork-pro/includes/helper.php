...
use madxartworkPro\Modules\ThemeBuilder\Module as EProModule;
...
class Helper{
    ...
    public function get_ae_acf_repeater_fields(){
	    ...
	    if ( isset( $_REQUEST['post'] ) ) {
		    ...
		    }elseif(get_post_type($_REQUEST['post']) == 'madxartwork_library' && class_exists('madxartworkPro\Modules\ThemeBuilder\Module')){

		    	$document = \madxartworkPro\Modules\ThemeBuilder\Module::instance()->get_document( $_REQUEST['post'] );
    ...
    function get_demo_post_data()
    {
        ...
        }elseif($GLOBALS['post']->post_type == 'madxartwork_library' && class_exists('madxartworkPro\Modules\ThemeBuilder\Module')){
            $document = \madxartworkPro\Modules\ThemeBuilder\Module::instance()->get_document( $GLOBALS['post']->ID );
            if ( $document ) {
    ...
    function is_canvas_enabled($tid){
        $template = get_post_meta($tid,'ae_madxartwork_template', true);
        if($template == 'ec'){
            return true;
        }
        return false;
    ...
    public function is_repeater_block_layout(){
        ...
        $doc = \madxartwork\Plugin::$instance->documents->get_current();
