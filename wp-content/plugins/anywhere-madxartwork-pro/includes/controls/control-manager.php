...
class Aepro_Control_Manager{
    ...
    {
		if(version_compare(madxartwork_VERSION,'1.5.5')){
			add_filter( 'madxartwork/init', [ $this, 'add_ae_tab'], 10,1);
		}else{
			add_filter( 'madxartwork/controls/get_available_tabs_controls', [ $this, 'add_ae_tab'], 10,1);
		}
    }
