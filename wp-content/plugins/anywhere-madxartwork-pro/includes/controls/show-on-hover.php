...
class ShowOnHover{
    ...
    public function __construct() {
        ...
        add_action( 'madxartwork/element/common/_section_style/after_section_end', [ $this, 'register_controls' ] );
    ...
    function before_section_render($element){
        ...
        //$hover_style = '';
        //$hover_style .= '<style>';
        //$hover_style .= '.madxartwork-element-' . $element->get_id() . ' .ae-show-on-hover-yes{ display: none; }';
        //$hover_style .= '.madxartwork-element-' . $element->get_id() . ':hover .ae-show-on-hover-yes{ display: block; }';
        //$hover_style .= '</style>';
        //echo $hover_style;
    }
