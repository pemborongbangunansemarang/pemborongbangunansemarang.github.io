...
class License{
    ...
    private static $_store_url = '';

    private static $_item_name = 'AnyWhere madxartwork Pro';
    ...
    public function ae_plugin_updater(){
        ...
        $edd_updater = new EDD_SL_Plugin_Updater( self::$_store_url, AE_PRO_FILE, array(
                ...
                'author' 	=> 'MadxArtwork',             // author of this plugin
                'beta'		=> false,
    ...
    public function admin_notices(){
        ...
        switch($license_status){
            ...
            case 'missing': break;
                ...
                <div class="error">
                    <p>
                        <strong>AnyWhere madxartwork Pro</strong><br/>
