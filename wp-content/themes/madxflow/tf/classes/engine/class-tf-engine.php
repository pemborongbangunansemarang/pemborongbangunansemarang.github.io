...
class TF_Engine {
	...
	public function empty_header_region() {
		if ( TF_Model::is_template_editable() ) {
			echo sprintf( '<p>%s</p>', __('To auto display a header here, create a new Template Part and name it "Header".', 'madx-flow') );
		}
	}
	...
	public function empty_sidebar_region() {
		if ( TF_Model::is_template_editable() ) {
			echo sprintf( '<p>%s</p>', __('To auto display a sidebar here, create a new Template Part and name it "Sidebar".', 'madx-flow') );
		}
	}
	...
	public function empty_footer_region() {
		if ( TF_Model::is_template_editable() ) {
			echo sprintf( '<p>%s</p>', __('To auto display a footer here, create a new Template Part and name it "Footer".', 'madx-flow') );
		}
	}
}
