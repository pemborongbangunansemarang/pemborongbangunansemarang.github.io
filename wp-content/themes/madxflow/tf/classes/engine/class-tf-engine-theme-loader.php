...
class TF_Engine_Theme_Loader {
	...
	protected function default_theme_info() {
		return apply_filters( 'tf_default_theme_info', array(
			'tf_theme_description' => __('Base theme is the default madx Flow theme', 'madx-flow'),
			'tf_theme_author' => 'madx',
			'tf_theme_author_link' => 'http://madxartwork.net',
