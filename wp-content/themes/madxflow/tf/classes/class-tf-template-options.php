            ...
            if ( in_array( $post_type, self::$post_types)) {
                 add_meta_box(
                            self::PREFIX.'_metaboxes',
                             __('Flow Template Options', 'madx-flow'),
            ...
            <div class="tf_interface">
                <div class="tf_lightbox_row">
                    <div class="tf_lightbox_label">
                        <label for="<?php echo self::PREFIX?>_template"><?php _e('Template','madx-flow')?></label>
                    </div>
                    <div class="tf_lightbox_input">
                        <div class="tf_custom_select">
                            <select name="<?php echo self::PREFIX?>[template]" id="<?php echo self::PREFIX?>_template">
                                <option value=""><?php _e('Select Template', 'madx-flow')?></option>
                ...
                <div id="tf_lightbox_radios">
                    <div class="tf_lightbox_row">
                        <div class="tf_lightbox_label">
                            <label for="<?php echo self::PREFIX?>_header_default"><?php _e('Header','madx-flow')?></label>
                        </div>
                        <div class="tf_lightbox_input">
                            ...
                            <label for="<?php echo self::PREFIX?>_header_default"><?php _e('Default', 'madx-flow')?></label>
                            <input <?php  checked($header, 'no', true )?> type="radio" name="<?php echo self::PREFIX?>[header]" id="<?php echo self::PREFIX?>_header_no" value="no" />
                            <label for="<?php echo self::PREFIX?>_header_no"><?php _e('No', 'madx-flow')?></label>
                            <?php if(!empty($template_parts)):?>
                                ...
                                <label for="<?php echo self::PREFIX?>_header_custom"><?php _e('Custom', 'madx-flow')?></label>
                                <div class="tf_custom_select">
                    ...
                    <div class="tf_lightbox_row">
                        <div class="tf_lightbox_label">
                            <label for="<?php echo self::PREFIX?>_sidebar_default"><?php _e('Sidebar','madx-flow')?></label>
                        </div>
                        <div class="tf_lightbox_input">
                            ...
                            <label for="<?php echo self::PREFIX?>_sidebar_default"><?php _e('Default', 'madx-flow')?></label>
                            ...
                            <label for="<?php echo self::PREFIX?>_sidebar_no"><?php _e('No', 'madx-flow')?></label>
                            <?php if(!empty($template_parts)):?>
                                ...
                                <label for="<?php echo self::PREFIX?>_sidebar_custom"><?php _e('Custom', 'madx-flow')?></label>
                                <div class="tf_custom_select">
                    ...
                    <div class="tf_lightbox_row">
                        <div class="tf_lightbox_label">
                            <label for="<?php echo self::PREFIX?>_footer_default"><?php _e('Footer','madx-flow')?></label>
                        </div>
                        <div class="tf_lightbox_input">
                            ...
                            <label for="<?php echo self::PREFIX?>_footer_default"><?php _e('Default', 'madx-flow')?></label>
                            <input <?php  checked($footer, 'no', true )?> type="radio" name="<?php echo self::PREFIX?>[footer]" id="<?php echo self::PREFIX?>_footer_no" value="no" />
                            <label for="<?php echo self::PREFIX?>_footer_no"><?php _e('No', 'madx-flow')?></label>
                            <?php if(!empty($template_parts)):?>
                                ...
                                <label for="<?php echo self::PREFIX?>_footer_custom"><?php _e('Custom', 'madx-flow')?></label>
                                <div class="tf_custom_select">
