...
<script type="text/html" id="tmpl-tf_styling_panel">
	...
	<div class="tf_styling_tabs">
		<ul>
			<li class="tf_styling_basic tf_active"><?php _e('Basic', 'madx-flow') ?></li>
			<li class="tf_styling_all"><?php _e('Advanced', 'madx-flow') ?></li>
		</ul>
	</div>
	<!-- /tf_styling_tabs -->
	...
	<div class="tf_styling_panel_bottom">
		<a href="#" class="tf_btn tf_btn_clear"><?php _e('Clear all', 'madx-flow') ?></a>
		<a href="#" class="tf_btn tf_btn_cancel"><?php _e('Cancel', 'madx-flow') ?></a>
		<a href="#" class="tf_btn tf_btn_save"><?php _e('Done', 'madx-flow') ?></a>
	</div>
...
<script type="text/html" id="tmpl-tf_styling_font_control">
	...
	<div class="tf_property_row">
		...
		<select name="family" class="tf_font_family">
			<option value=""></option>
			<optgroup label="<?php _e( 'Web Safe Fonts', 'madx-flow' ); ?>">
				<?php
			...
			<optgroup label="<?php _e( 'Google Fonts', 'madx-flow' ); ?>">
				<?php
	...
	<div class="tf_property_row">
		...
		<label><?php _e('Font Size', 'madx-flow') ?></label>
	</div>
	<!-- /tf_property_row -->
	...
	<div class="tf_property_row">
		...
		<label><?php _e('Line Height', 'madx-flow') ?></label>
	</div>
	<!-- /tf_property_row -->
	...
	<div class="tf_property_row">
		<div class="tf_custom_color_wrap">
			...
			<label class="tf_color_picker_label"><?php _e( 'Color', 'madx-flow' ); ?></label>
		</div>
	</div>
	<!-- /tf_property_row -->
...
<script type="text/html" id="tmpl-tf_styling_border_control">
	...
	// Sides
	$sides = array(
		'top'    => __( 'Border Top', 'madx-flow' ),
		'right'  => __( 'Border Right', 'madx-flow' ),
		'bottom' => __( 'Border Bottom', 'madx-flow' ),
		'left'   => __( 'Border Left', 'madx-flow' ),
	);

	// Style
	$styles = array(
		'' => '',
		'solid'  => __( 'Solid', 'madx-flow' ),
		'dotted' => __( 'Dotted', 'madx-flow' ),
		'dashed' => __( 'Dashed', 'madx-flow' ),
		'double' => __( 'Double', 'madx-flow' ),
	...
	foreach ( $sides as $side => $side_label ) : ?>
		<div class="tf_property_row <?php echo $first ? 'useforall' : 'component'; ?>">
			<div class="tf_border_property_row">
				<div class="wide-label tf_border_position_name <?php echo $first ? 'same-label' : ''; ?>" <?php echo $first ? 'data-same="' . __( 'Border', 'madx-flow' ) . '" data-notsame="' . $side_label . '"' : ''; ?>><?php echo
					$side_label;
					?></div>
				...
				<label class="dimension-unit-label"><?php _e( 'px', 'madx-flow' ); ?></label>
		...
		<div class="tf_border_property_row">
			<div class="tf_checkbox_wrap">
				...
				<label for="<?php echo $same_id; ?>" class="tf_apply_all">
					<?php _e( 'Apply to all borders.', 'madx-flow' ); ?>
				</label>
			</div>
		</div>
	</div>
