...
<head>
	...
	<?php
	/**
	 * @hooked madx_Flow::title_tag_fallback (if WP version < 4.1) - 10
	 */
	wp_head(); ?>
</head>
			...
			<div id="headerwrap">
				...
				<div data-region-area="header" class="tf_template_part_region tf_template_part_region-edit">
					<a href="#" data-region="header" class="tf_interface tf_template_region_button tf_template_region_button-add">
						...
						<?php _e('Add Template Part', 'madx-flow') ?>
					</a>
					<div class="tf_template_part_region_render_content">
						...
						<div class="tf_active_block">
							...
							<div class="tf_active_block_menu tf_interface">
								<ul class="tf_active_block_menu_ul">
									<li class="tf_active_block_menu_li"><span class="ti-menu"></span>
										<ul>
											<li>
												<a class="tf_lightbox_link_region-swap" title="<?php _e('Swap', 'madx-flow') ?>" href="#">
													<span class="ti-back-right"></span>
												</a>
											</li>
											<li>
												<a class="tf_lightbox_link_region-edit" data-edit-url="<?php echo TF_Model::get_template_part_edit_url( $TF_Layout->region_header, array( 'tf_region' => 'header', 'parent_template_id' => $TF_Layout->layout_id ) ); ?>" title="<?php _e('Edit', 'madx-flow' ) ?>" href="#">
													<span class="ti-pencil"></span>
												</a>
											</li>
											<li>
												<a class="tf_lightbox_link_region-delete" title="<?php _e('Delete', 'madx-flow') ?>" href="#">
							...
							<div class="tf_active_block_caption tf_interface"><?php echo sprintf( __('Template Part: %s', 'madx-flow'), TF_Model::get_template_part_title( TF_Model::get_shortcode_atts_val( $TF_Layout->region_header, 'slug' ) ) ); ?></div>
						...
						<div data-region-area="sidebar" class="tf_template_part_region tf_template_part_region-edit">
							...
							<div class="tf_template_part_region_render_content">
								...
								<div class="tf_active_block">
										...
										<ul class="tf_active_block_menu_ul">
											<li class="tf_active_block_menu_li"><span class="ti-menu"></span>
												<ul>
													...
													<li>
														<a class="tf_lightbox_link_region-edit" data-edit-url="<?php echo TF_Model::get_template_part_edit_url( $TF_Layout->region_sidebar, array( 'tf_region' => 'sidebar', 'parent_template_id' => $TF_Layout->layout_id ) ); ?>" title="<?php _e('Edit', 'madx-flow' ) ?>" href="#">
															<span class="ti-pencil"></span>
														</a>
													</li>
													<li>
									...
									<div class="tf_active_block_caption tf_interface"><?php echo sprintf( __('Template Part: %s', 'madx-flow'), TF_Model::get_template_part_title( TF_Model::get_shortcode_atts_val( $TF_Layout->region_sidebar, 'slug' ) ) ); ?></div>
									<div class="tf_active_block_element">
				...
				<div data-region-area="footer" class="tf_template_part_region tf_template_part_region-edit">
					...
					<div class="tf_template_part_region_render_content">
						...
						<div class="tf_active_block">
								...
								<ul class="tf_active_block_menu_ul">
									<li class="tf_active_block_menu_li"><span class="ti-menu"></span>
										<ul>
											...
											<li>
												<a class="tf_lightbox_link_region-edit" data-edit-url="<?php echo TF_Model::get_template_part_edit_url( $TF_Layout->region_footer, array( 'tf_region' => 'footer', 'parent_template_id' => $TF_Layout->layout_id ) ); ?>" title="<?php _e('Edit', 'madx-flow' ) ?>" href="#">
													<span class="ti-pencil"></span>
												</a>
											</li>
											<li>
							...
							<div class="tf_active_block_caption tf_interface"><?php echo sprintf( __('Template Part: %s', 'madx-flow'), TF_Model::get_template_part_title( TF_Model::get_shortcode_atts_val( $TF_Layout->region_footer, 'slug' ) ) ); ?></div>
							<div class="tf_active_block_element">
