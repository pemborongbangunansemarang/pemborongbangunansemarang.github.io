...
<div class="tf_front_panel tf_interface">	
	<div id="tf_module_panel" class="tf_module_panel clearfix">
		...
		<a class="tf_slide_builder_module_panel" href="#"><?php _e('Slide', 'madx-flow') ?></a>
		...
		<div class="builder_save_front_panel">
			<a href="#" class="tf-front-save"><?php _e('Save', 'madx-flow') ?></a>
			<a href="<?php echo esc_url( TF_Model::get_builder_close_url() ); ?>" class="tf-front-close"><?php _e('Close', 'madx-flow') ?></a>
		</div>
