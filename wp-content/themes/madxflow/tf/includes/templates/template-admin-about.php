<div class="wrap about-wrap">
	...
	<h1><?php echo sprintf( __('Welcome to madx Flow %s', 'madx-flow'), $TF->get_version() ); ?></h1>
	...
	<div class="changelog">
		<div class="feature-section col three-col">
			<div>
				...
				<p>madx Flow allows you to switch, import, export, and create your own <a href="http://madxartwork.net/doc/themes" target="_blank">Flow themes</a> with drag &amp; drop.</p>
			...
			<div>
				...
				<p><a href="http://madxartwork.net/doc/templates" target="_blank">Templates</a> are used to render the page layout on the frontend. You can edit and design your own templates.</p>
			...
			<div class="last-feature">
				...
				<p><a href="http://madxartwork.net/doc/template-parts" target="_blank">Template Parts</a> are the layout pieces used in templates such as: Header, Sidebar, and Footer.</p>
			...
			<div>
				...
				<p><a href="http://madxartwork.net/doc/global-styling" target="_blank">Global Styling</a> panel allows you to customize the general styling of the theme elements (body, font, background, headings, etc.).</p>
			...
			<div>
				...
				<p>In <a href="http://madxartwork.net/doc/settings" target="_blank">Settings</a> page, you can specify the favicon, header code, footer code, and other framework options.</p>
			...
			<div class="last-feature">
				...
				<p>If you need help with the drag &amp; drop Builder, refer to the <a href="http://madxartwork.net" target="_blank">Builder Documentation</a>.</p>
			</div>
		</div>
	</div>
	...
	<div class="changelog">
		<div class="feature-section">
			<ul>
				<li><span class="dashicons dashicons-arrow-right"></span> <a href="http://madxartwork.net/docs">Documentation</a></li>
				<li><span class="dashicons dashicons-arrow-right"></span> <a href="http://madxartwork.net/forums">Support Forums</a></li>
				<li><span class="dashicons dashicons-arrow-right"></span> <a href="http://madxartwork.net/contact">Contact Us</a></li>					</ul>
		</div>
	</div>
