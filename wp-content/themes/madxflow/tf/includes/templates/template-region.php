...
function tf_template_region_content_empty() {
	if ( TF_Model::is_template_editable() ) {
		echo sprintf( '<h4>%s</h4>', __('This is Content Section', 'madx-flow') );
		echo sprintf( '<p>%s</p>', __('If you would like to add content to this section, you may do so by editing active TF Template > Add Modules', 'madx-flow') );
	}
}
