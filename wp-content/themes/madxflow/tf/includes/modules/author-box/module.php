...
class TF_Module_Author_Box extends TF_Module {
	...
	public function __construct() {
		parent::__construct( array(
			'name' => __( 'Author Box', 'madx-flow' ),
			'slug' => 'author-box',
			'shortcode' => 'tf_author_box',
			'description' => __( 'Author Box', 'madx-flow' ),
			'category' => 'single'
	...
	public function fields() {
		return apply_filters( 'tf_module_author_box_fields', array(
			'avatar_size' => array(
				'type' => 'text',
				'label' => __( 'Author Avatar Size', 'madx-flow' ),
