...
class TF_Module_Template_Part extends TF_Module {
	...
	public function __construct() {
		parent::__construct( array(
			'name' => __( 'Template Part', 'madx-flow' ),
			'slug' => 'template-part',
			'shortcode' => 'tf_module_template_part',
			'description' => __( 'Show content of selected Template Part', 'madx-flow' ),
			'category' => 'global'
		) );
	}
                ...
                if(!empty($template_parts)){
                    ...
                    if(!empty($options)){
                        return apply_filters( 'tf_module_template_part_fields', array(
                                'part'  => array(
                                        'type' => 'select',
                                        'label' => __( 'Template_Part', 'madx-flow' ),
                                        'options' => $options,
                                )
	...
	public function styles() {
		return apply_filters( 'tf_module_template_part_styles', array(
			'tf_module_template_part_container' => array(
				'label' => __( 'Template Part Container', 'madx-flow' ),
