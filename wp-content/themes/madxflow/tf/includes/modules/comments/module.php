...
class TF_Module_Comments extends TF_Module {
	...
	public function __construct() {
		parent::__construct( array(
			'name' => __( 'Comments', 'madx-flow' ),
			'slug' => 'comments',
			'shortcode' => 'tf_comments',
			'description' => __( 'Display the comments.', 'madx-flow' ),
	...
	public function fields() {
		return apply_filters( 'tf_module_comments_fields', array(
			'comments_per_page' => array(
				'type' => 'text',
				'label' => __( 'Comments Per Page', 'madx-flow' ),
				'class' => 'tf_input_width_10',
				'description' => '<br>' . sprintf( __( 'Defaults to the number set in <a href="%s">Settings > Discussion</a>.', 'madx-flow' ), admin_url( 'options-discussion.php' ) )
			),
			'avatar_size' => array(
				'type' => 'text',
				'label' => __( 'Avatar Size', 'madx-flow' ),
				'class' => 'tf_input_width_10',
				'description' => 'px'
			),
		) );
