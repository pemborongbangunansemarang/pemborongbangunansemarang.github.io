		...
		return apply_filters( 'tf_module_lists_posts_fields', array(
			...
			'orderby' => array(
				...
				'options' => array(
					...
					array( 'name' => __('Comment Count','madx-flow'), 'value' => 'comment_count' ),
                        ...
                        'category'=>array(
                                ...
                                'multiple'=>TRUE,
                                "size"    =>10,
				'label' => __('Category', 'madx-flow'),
				'options' => $cats,
				'default' => array( '0' )
                        ),
                        'offset' => array(
				'type' => 'text',
				'label' => __( 'Offset', 'madx-flow'),
				...
				'default' => 0
                        ...
                        'post_per_page' => array(
				'type' => 'text',
				'label' => __( 'Show Number of Posts', 'madx-flow'),
				'class' => 'tf_input_width_10',
			...
			'pagination' => array(
				...
				'options' => array(
					array( 'name' => __('No','madx-flow'), 'value' => 'no', 'selected' => true ),
					array( 'name' => __('Yes','madx-flow'), 'value' => 'yes' ),
				)
			),
			'content' => array(
				'type' => 'builder',
