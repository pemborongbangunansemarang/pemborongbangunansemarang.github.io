...
class TF_Module_Site_Logo extends TF_module {
	...
	public function __construct() {
		parent::__construct(array(
			'name' => __( 'Site Logo', 'madx-flow' ),
			'slug' => 'site-logo',
			'description' => __( 'Site logo module', 'madx-flow' ),
	...
	public function fields() {
		return apply_filters( 'tf_module_site_logo_fields', array(
			'logo_type' => array(
				...
				'label' => '&nbsp;',
				'options' => array(
					array( 'name' => __( 'Text', 'madx-flow' ), 'value' => 'text', 'selected' => true ),
					array( 'name' => __( 'Image', 'madx-flow' ), 'value' => 'image' ),
				),
			...
			'logo_text' => array(
				'type' => 'text',
				'label' => __( 'Logo Text', 'madx-flow' ),
				'class' => 'tf_input_width_70',
				'description' => '<br/>' . sprintf( __( 'Leave blank to use the Site Title in <a href="%s">WP > Settings</a>', 'madx-flow' ), admin_url( 'options-general.php' ) ),
				'row_class' => 'logo_type logo_type-text',
			),
			'logo_image' => array(
				'type' => 'image',
			...
			'logo_link' => array(
				'type' => 'text',
				'label' => __( 'Logo Link', 'madx-flow' ),
				'class' => 'tf_input_width_70', // this is not working
				'description' => '<br/>' . __( 'Leave blank to use the Site URL', 'madx-flow' ),
			)
		) );
	}
