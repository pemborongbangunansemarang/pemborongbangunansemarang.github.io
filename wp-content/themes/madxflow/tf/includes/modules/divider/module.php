...
class TF_Module_Divider extends TF_Module {
	...
	public function fields() {
		...
		return apply_filters( 'tf_module_divider_fields', array(
			'layout'  => array(
				'type'       => 'layout',
				'label'      => __( 'Divider Layout', 'madx-flow' ),
				'options'    => array(
					array( 'img' => $image_base . '/solid.png', 'value' => 'solid', 'label' => __( 'Solid', 'madx-flow' ), 'selected' => true ),
					array( 'img' => $image_base . '/dashed.png', 'value' => 'dashed', 'label' => __( 'Dashed', 'madx-flow' ) ),
					array( 'img' => $image_base . '/dotted.png', 'value' => 'dotted', 'label' => __( 'Dotted', 'madx-flow' ) ),
					array( 'img' => $image_base . '/double.png', 'value' => 'double', 'label' => __( 'Double', 'madx-flow' ) ),
				)
			),
			'thinkness' => array(
				'type' => 'number',
				'label' => __( 'Stroke Thickness', 'madx-flow' ),
			...
			'divider_color' => array(
				'type' => 'color',
				'label' => __( 'Divider Color', 'madx-flow' ),
			)
		) );
	}
