...
class TF_Module_Video extends TF_Module {
	...
	public function fields() {
		...
		return apply_filters( 'tf_module_video_fields', array(
			'layout'  => array(
				'type'       => 'layout',
				'label'      => __( 'Video Layout', 'madx-flow' ),
				'options'    => array(
					array( 'img' => $image_base . '/video-top.png', 'value' => 'video-top', 'label' => __( 'Video Top', 'madx-flow' ), 'selected' => true ),
					array( 'img' => $image_base . '/video-left.png', 'value' => 'video-left', 'label' => __( 'Video Left', 'madx-flow' ) ),
					array( 'img' => $image_base . '/video-right.png', 'value' => 'video-right', 'label' => __( 'Video Right', 'madx-flow' ) ),
					array( 'img' => $image_base . '/video-overlay.png', 'value' => 'video-overlay', 'label' => __( 'Video Overlay', 'madx-flow' ) ),
				)
			),
			'video_url' => array(
				'type' => 'text',
				'label' => __( 'Video URL', 'madx-flow' ),
				'class' => 'tf_input_width_70',
			),
			'video_width_multi' => array(
				'type' => 'multi',
				'label' => __( 'Video Width', 'madx-flow' ),
				'fields' => array(
					'video_width' => array(
						'type' => 'number',
					...
					'video_width_unit' => array(
						...
						'label' => '',
						'options' => array(
							array( 'name' => __( 'px', 'madx-flow' ), 'value' => 'px', 'selected' => true ),
							array( 'name' => __( '%', 'madx-flow' ), 'value' => '%' ),
						),
						'description' => ''
					),
				),
			...
			'video_title' => array(
				'type' => 'text',
				'label' => __( 'Video Title', 'madx-flow' ),
				'class' => 'tf_input_width_70',
			),
			'video_title_link' => array(
				'type' => 'text',
				'label' => __( 'Video Title Link', 'madx-flow' ),
				'class' => 'tf_input_width_70',
			),
			'video_caption' => array(
				'type' => 'textarea',
				'label' => __( 'Video Caption', 'madx-flow' ),
				'class' => 'tf_input_width_70',
			)
		) );
	}
	...
	public function styles() {
		return apply_filters( 'tf_module_video_styles', array(
			...
			'tf_module_video_title_link_hover' => array(
				'label' => __( 'Video Title Link Hover', 'madx-flow' ),
	...
	public function render_shortcode( $atts, $content = null ) {
		...
		<div class="tf_video_content">
			...
			<div class="tf_video_caption">
				<?php echo apply_filters( 'madx_builder_module_content', $video_caption ); ?>
