...
class TF_Module_Image extends TF_Module {
	...
	public function fields() {
		...
		return apply_filters( 'tf_module_image_fields', array(
			'layout'  => array(
				'type'       => 'layout',
				'label'      => __( 'Image Style', 'madx-flow' ),
				'options'    => array(
					array( 'img' => $image_base . '/image-top.png', 'value' => 'image-top', 'label' => __( 'Image Top', 'madx-flow' ), 'selected' => true ),
					array( 'img' => $image_base . '/image-left.png', 'value' => 'image-left', 'label' => __( 'Image Left', 'madx-flow' ) ),
					array( 'img' => $image_base . '/image-right.png', 'value' => 'image-right', 'label' => __( 'Image Right', 'madx-flow' ) ),
					array( 'img' => $image_base . '/image-overlay.png', 'value' => 'image-overlay', 'label' => __( 'Image Overlay', 'madx-flow' ) ),
					array( 'img' => $image_base . '/image-center.png', 'value' => 'image-center', 'label' => __( 'Image Center', 'madx-flow' ) ),
				)
			),
			'image_url' => array(
				'type' => 'image',
				'label' => __( 'Image URL', 'madx-flow' ),
				'class' => 'tf_input_width_70',
			),
			'image_appearance' => array(
				'type' => 'checkbox_group',
				'label' => __( 'Image Appearance', 'madx-flow' ),
				'options' => array(
					'rounded' => __( 'Rounded', 'madx-flow' ),
					'drop-shadow' => __( 'Drop Shadow', 'madx-flow' ),
					'bordered' => __( 'Bordered', 'madx-flow' ),
					'circle' => __( 'Circled', 'madx-flow' ),
				),
				'is_array' => true,
			),
                        'image_size' => array(
				'type' => 'select',
				'label' => __('Image Size', 'madx-flow'),
				'options' => tf_get_image_sizes_list()
			),
			'image_dimensions' => array(
				'type' => 'multi',
				'label' => __( 'Image Dimensions', 'madx-flow' ),
				'fields' => array(
					'width' => array(
						'type' => 'number',
						'label' => __( '', 'madx-flow' ),
			...
			'title' => array(
				'type' => 'text',
				'label' => __( 'Image Title', 'madx-flow' ),
				'class' => 'tf_input_width_70',
			),
			'link' => array(
				'type' => 'text',
				'label' => __( 'Image Link', 'madx-flow' ),
				'class' => 'tf_input_width_70',
			),
			'alt' => array(
				'type' => 'text',
				'label' => __( 'Alt Text', 'madx-flow' ),
				'class' => 'tf_input_width_70',
			),
			'caption' => array(
				'type' => 'textarea',
				'label' => __( 'Image Caption', 'madx-flow' ),
				'class' => 'tf_input_width_70',
			)
		) );
	}
	...
	public function styles() {
		return apply_filters( 'tf_module_image_styles', array(
			'tf_module_image_container' => array(
				'label' => __( 'Image Container', 'madx-flow' ),
