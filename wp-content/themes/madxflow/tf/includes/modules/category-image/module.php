...
class TF_Module_Category_Image extends TF_Module {
	...
	public function __construct() {
		parent::__construct( array(
			'name' => __('Category Image', 'madx-flow' ),
			'slug' => 'category-image',
        ...
        public function category_add_fields(){
            ?>  
                <div class="form-field term-image-wrap">
                    <label for="tf-img"><?php _e('Category Image','madx-flow')?></label>
                    <input type="text" name="tf-img" id="tf-img" size="40"/>
                    <p><?php _e('Enter full image URL (eg. http://yoursite.com/image.jpg)','madx-flow'); ?></p>
                </div>
            <?php
        }
        /**
        ...
        public function category_edit_fields($term){
            ...
            ?>
                <tr class="form-field term-image-wrap"> 
                    <th scope="row"><label for="tf-img"><?php _e('Category Image','madx-flow')?></label></th>
                    <td>
                        ...
                        <p class="description"><?php _e('Enter full image URL (eg. http://yoursite.com/image.jpg)','madx-flow'); ?></p>
                    </td>
                </tr>
            <?php
        }
