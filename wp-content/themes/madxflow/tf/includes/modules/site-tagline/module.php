...
class TF_Module_Site_Tagline extends TF_module {
	...
	public function __construct() {
		parent::__construct(array(
			'name' => __( 'Site Tagline', 'madx-flow' ),
			'slug' => 'site-tagline',
			'description' => __( 'Site tagline module', 'madx-flow' ),
	...
	public function fields() {
		return apply_filters( 'tf_module_site_tagline_fields', array(
			...
			'tagline_text' => array(
				'type' => 'text',
				'label' => __( 'Tagline Text', 'madx-flow' ),
				'class' => 'tf_input_width_70',
				'description' => '<br/>' . sprintf( __( 'Leave blank to use the Tagline in <a href="%s">WP > Settings</a>', 'madx-flow' ), admin_url( 'options-general.php' ) ),
			)
		) );
	}
	...
	public function styles() {
		return apply_filters( 'tf_module_site_logo_styles', array(
			'tf_module_site_tagline' => array(
				'label' => __( 'Site Tagline', 'madx-flow' ),
