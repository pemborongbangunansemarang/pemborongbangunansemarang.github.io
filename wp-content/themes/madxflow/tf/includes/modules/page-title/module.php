...
class TF_Module_Page_Title extends TF_Module {
	...
	public function __construct() {
		parent::__construct(array(
			'name' => __('Page Title', 'madx-flow'),
			'slug' => 'page-title',
			'shortcode' => 'tf_page_title',
			'description' => __('Display page title on the page', 'madx-flow'),
			'category' => 'page'
		));
	}
		...
		$atts = shortcode_atts( array(
			'title_tag' => ''
                ...
                if ( ! TF_Model::is_template_page() ) {
                    ...
                    $output = sprintf('<p>%s</p>', __('<strong>Page Title</strong>', 'madx-flow') );
                }
		return $output;
	}
}
